...
USE `challenge`;
CREATE DATABASE IF NOT EXISTS `reward` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `reward`;
CREATE DATABASE IF NOT EXISTS `redemption` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `redemption`;
CREATE DATABASE IF NOT EXISTS `epayment` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `epayment`;
CREATE DATABASE IF NOT EXISTS `icebreakers` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `icebreakers`;